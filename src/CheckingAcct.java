/**
 * @author: Jenny Zhen
 * @name: CheckingAcct.java
 * @date: 04.24.12
 */

/**
 * $Id: CheckingAcct.java,v 1.10 2012-05-16 01:48:37 jxz6853 Exp $
 * $Revision: 1.10 $
 * $Log: CheckingAcct.java,v $
 ...
 *
 * Revision 1.6  2012-05-09 07:26:37  jxz6853
...
/**
 * CheckingAcct() represents a checking account.
 */
public class CheckingAcct implements Account {
	private static final int MINBALANCE = 50; //minimum account balance
	...
	/**
	 * Constructor: creates an instance of a checking account.
	 * @param ID - user ID
	 * @param pin - user pin
	 * @param balance - starting balance
	 */
	public CheckingAcct(String ID, String pin, double balance) {
		this.type = "Checking";
		this.ID = ID;
		this.pin = pin;
	 ...
	 * @return String representing the type of account. In this case, checking.
	 */
